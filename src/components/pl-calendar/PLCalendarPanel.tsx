...
import { PLDayViewPage } from "./PLDayViewPage";
...
export function PLCalendarPanel({ trades, dateRange }: PLCalendarPanelProps) {
  ...
  const [pageView, setPageView] = useState<"calendar" | "day-detail">("calendar");
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="min-h-[500px]">
        {pageView === "day-detail" && selectedDayKey && selectedSummary ? (
          <PLDayViewPage
            summary={selectedSummary}
            onBack={() => setPageView("calendar")}
          />
        ) : view === "month" ? (
          <div className="space-y-6">
            <MonthlyPLCalendar
